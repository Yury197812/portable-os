"""Cluster 5000 sequences into 256 buckets WITH full sequence metadata.

Loops over 5000 IDs from atomize_5000, gathers first4 terms via DB,
computes structural hash, builds cluster statistics.
"""
...
def main() -> int:
    ...
    for entry in full_data["top_30_variance"]:
        indexed[entry["a_id"]] = entry
    print(f"indexed from 5000 file: {len(indexed)} sequences (top30+30+30)")
