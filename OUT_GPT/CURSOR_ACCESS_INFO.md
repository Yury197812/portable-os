...
### 4. Cursor AI Features
- Cursor uses the same Git integration as VSCode
- Token works for all git operations
- No additional setup needed for AI features
...
4. Cursor is a fork of VSCode — same Git setup applies
